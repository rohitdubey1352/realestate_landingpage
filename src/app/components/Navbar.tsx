      ...
      <nav>
        ...
        <div className="content">
          <div className="navbar flex items-center justify-between">
            ...
            {/* ENQUIRE NOW button */}
            <button className="hidden md:block text-sm tracking-wider font-semibold text-sky-400/100 hover:text-white border-solid border-2 border-sky-500 py-3 px-8 rounded-lg hover:bg-sky-400 md:text-sky-400/75">
              ENQUIRE NOW
            </button>
          </div>
        </div>
